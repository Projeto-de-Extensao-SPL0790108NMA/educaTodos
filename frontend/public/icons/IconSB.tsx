// Exportar caminhos públicos dos ícones para uso com <img src="..."> ou
// com `component='img'` em MUI, assim como o `logo.svg`.
export const HouseIcon = '/icons/house.svg';
export const HatIcon = '/icons/hat.svg';
